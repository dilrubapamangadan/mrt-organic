<template>
 ...
 <img src="/assets/custom/img/vector4.png" width="298" height="237" class="d-block vector-about" />
      </div> 
      <img src="/assets/custom/img/shade-btm.png" width="1920" height="314" class="w-100" />
                  ...
                  <div class="row">
                    <div class="col-lg-4 left">
                       <div class="border-inner h-100">
                           <img src="/assets/custom/img/balan.jpg" width="444" height="390" class="w-100 d-block" />
                       </div>
                    </div>
                     <div class="col-lg-8 right text-white">
                       <div class="border-inner h-100 text-center">
                           ...
                           Born in a traditional family of ayurvedic physicians of 5 generations, Mr MahiBalan, the founder and CEO of MRT Organics learned the basics of plant science from his great grandfather.

                       </div>
                    </div>
                  </div>
               <img src="/assets/custom/img/vector5.png" width="237" height="188" class="vector" />
        </div>
      </section>
<!-- end: Ceo -->
<!--  -->
