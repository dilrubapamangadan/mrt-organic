...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/custom/img/favicon.ico" type="image/x-icon') }}">
    <link rel="icon" href="{{ asset('assets/custom/img/favicon.ico" type="image/x-icon') }}">
    <!-- Bootstrap CSS -->
